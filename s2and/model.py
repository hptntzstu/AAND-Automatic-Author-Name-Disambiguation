...
from s2and.autofeaturizer import FeaturizationInfo, many_pairs_featurize, preprocess_features
...
class AutoClusterer:
    """
    A wrapper for learning a clusterer based on AAND
    ...
    def __init__(
        ...
        feature_params: Optional[Any] = None,
    ):
    ...
    def make_distance_matrices(
        ...
        while True:
            ...
            # normalize and fill nan value
            batch_features, _, batch_nameless_features, _ = preprocess_features(features, 'test', self.feature_params)
